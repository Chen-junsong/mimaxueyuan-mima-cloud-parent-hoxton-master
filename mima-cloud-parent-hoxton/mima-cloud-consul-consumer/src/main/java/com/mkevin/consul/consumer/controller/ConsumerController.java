 ...
 */
package com.mkevin.consul.consumer.controller;

import com.mkevin.consul.consumer.entity.User;
...
public class ConsumerController {
	...
	public User getUser2(User user) {
		...
		//一下两种方式均可
		User result1 = restTemplate.getForObject("http://mima-cloud-consul-producer/getuser2?id={id}&name={name}", User.class, params);
		User result2 = restTemplate.getForObject("http://mima-cloud-consul-producer/getuser2?id={id}&name={name}", User.class, user.getId(),user.getName());
		return result2;
	}
